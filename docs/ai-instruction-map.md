...
| 時間警告 | game-core.json / timeWarning.message・deliveryInstructions、hosted-runtime.ts / tick | 残り60秒などをどの文面・口調で知らせるか |
...
3. timeWarning.messageには「残り時間が{thresholdSeconds}秒を切ったよ」という直接の文面がある。
