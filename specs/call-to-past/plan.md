...
`skills/call-to-past/`にSKILL.md、agents/openai.yaml、assets/masters.json、references、scripts、testsを置く。Python3.10+の標準ライブラリを基本とし、画像確認にはPillow、動画送信には既存h3-videoとfal_client、動画QCにはffprobe/ffmpegを使う。直接OpenAI APIクライアントは作らない。
