...
## 現在の残り
P7の開発用AWS/OIDC設定とmain自動配信は完了。P8はユーザーによるAWS上の一通りのプレイ確認済み。同時5人の実測・審査環境への手動配信・実Liveを伴う運用確認など、verification.mdの未完了ゲートを残す。AGENTS.mdはユーザーの明示承認後に同期済み。全完了とは扱わない。
